import {
    Services, useCreateAccount, useCreateEmailSession,
...
import { Fragment, HDivider, HStack, Heading, Icon, ReactView, SecureField, Spacer, Text, UINavigate, UIView, VStack, cLeading, cTop, cTopLeading, urlFriendly, useNavigate, useState } from "@tuval/forms";
...
export class SignupController extends CelminoController {
                    ...
                    VStack({ alignment: cTop })(
                        ...
                        VStack(
                            VStack({alignment:cTopLeading})(
                                Heading('Sign up').fontSize(80).foregroundColor('#090e13').lineHeight('1.4')
