...
export const SaveAssigneeFieldAction = (formMeta, action) => UIViewBuilder(() => {
...
SaveAssigneeFieldAction.Id = nanoid()
export const AddAssigneeFieldDialog = (onNewFieldAdded: Function) => ({
    ...
    "actions": [
        {
            "label": "custom",
            "type": SaveAssigneeFieldAction.Id 
        }
    ],
    "fieldMap": {
        "name": {
...
FormBuilder.injectAction(SaveAssigneeFieldAction);
