...
import {
    ...
    ShowSuccessToast,
    ShowToast,
    Spacer, Spinner, SvgIcon, TextField,
    UIViewBuilder,
    UIWidget,
...
export function DocumentName(documentId: string, isOpen: boolean, onClickCallback: Function) {

    const selected = getDocumentId() === documentId;
                ...
                isLoading ? Spinner() :
                    ...
                    mode === 'readonly' ?
                        ...
                        HStack({ alignment: cLeading, spacing: 5 })(
                                ...
                                MenuButton()
                                    .model([
                                        ...
                                        },
                                        {
                                            ...
                                            onClick: () => {
                                                DynoDialog.Show(AddDocumentDialog(workspaceId, appletId, documentId, `${document.path}/${document.$id}`))
                                            }
                                        },
                                    ])
                                    .icon(Icons.Add),
                                MenuButton()
                                    .model([
...

                                        {
                                            ...
                                            onClick: () => {
                                                DynoDialog.Show(AppletDescriptionDialog(documentId))
                                            }
                                        },
                                        {
                                            title: 'Delete',
                            ...
                            .draggable(true)
                            .onDragStart((e) => {
                                e.dataTransfer.setData('text/plain', JSON.stringify(documentId));
                            })
