...
export const myVerticalListSortingStrategy = (items: any[]) => {
    ...
    return ({
        ...
        console.log('activeIndex', activeIndex, 'index', index, 'rects', rects, 'overIndex', overIndex)

        const activeNodeRect = rects[activeIndex] ?? fallbackActiveRect;
        if (items[overIndex].id === "1") {
            return null;
        }
