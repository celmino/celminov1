...
import { TreeNode2 } from './views/TreeNode2';
...
export class AppController2 extends UIController {
    ...
    public override LoadView(): UIView {
        ...
        const { node,workspaceId, appletId, appletName, subNodes,requestMenu,requestEditMenu, requestNavigation, isEditing, editingChanged, titleChanged, isSelected , iconName, iconCategory} = this.props.config || {};
