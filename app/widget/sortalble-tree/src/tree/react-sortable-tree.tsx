...
class ReactSortableTree extends React.Component<any, any> {
  dndManager;
  treeId;
  dndType;
  nodeContentRenderer;
  treePlaceholderRenderer;
  treeNodeRenderer;
  ...
  componentWillUnmount() {
    (this as any).clearMonitorSubscription();
  }
...
(ReactSortableTree as any).propTypes = {
...
(ReactSortableTree as any).defaultProps = {
  canDrag: true,
  canDrop: null,
