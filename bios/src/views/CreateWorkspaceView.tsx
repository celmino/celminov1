...
import { RealmServiceBroker, useAccount, useCreatePersonelRealm } from "@celmino/platform";
        ...
        UIViewBuilder(() => {
            ...
            return (
                VStack(
                    ...
                    VStack({ spacing: 10 })(
                        Heading(account?.name).fontSize(28).foregroundColor('#090e13')
                            .fontFamily('Graphik Medium,sans-serif'),
                        Heading(account.email).fontSize('28').foregroundColor('#090e13')
                            .fontFamily('Graphik Medium,sans-serif'),
                        HStack(
                        ...
                        Heading('Realms').fontFamily('"Hagrid", sans-serif').fontSize(60).foregroundColor('#090e13').lineHeight(90),
                        ...
                        HStack({ alignment: cLeading })(
                            Text('Create a new realm').fontFamily('"Graphik Regular", sans-serif')
                                .fontSize(20)
                        ).height().padding('16px 20px 16px 0'),
                        HStack({ alignment: cLeading })(
                            Text('Log in with another email')
                                .fontFamily('"Graphik Regular", sans-serif').fontSize(20)
                        ).height().padding('16px 20px 16px 0')
                            .onClick(() => {
                                navigate('/logout');
                            }),
