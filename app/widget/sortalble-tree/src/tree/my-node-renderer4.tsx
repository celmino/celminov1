...
class MyNodeRendererDefault4 extends React.Component<any, any> {
    render() {
        const {
        ...
        return (
            HStack({ alignment: 'cTopLeading' })(
                ReactView(
                    <div style={{ width: '100%' }} {...otherProps}>
                        <div>
                            {
                                connectDragPreview(
                                    <div
...
(MyNodeRendererDefault4 as any).defaultProps = {
    isSearchMatch: false,
    isSearchFocus: false,
    canDrag: false,
...
(MyNodeRendererDefault4 as any).propTypes = {
...
export default MyNodeRendererDefault4;
