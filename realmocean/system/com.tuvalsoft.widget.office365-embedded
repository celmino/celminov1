...
var getPopupPositionProperties = function (_a) {
    var _b = _a.width, width = _b === void 0 ? 600 : _b, _c = _a.height, height = _c === void 0 ? 600 : _c;
    var left = (screen.width / 2) - (width / 2);
    var top = (screen.height / 2) - (height / 2);
    return "left=".concat(left, ",top=").concat(top, ",width=").concat(width, ",height=").concat(height);
};
var MyTestController = /** @class */ (function (_super) {
    ...
    MyTestController.prototype.LoadView = function () {
        ...
        return ((0,_tuval_forms__WEBPACK_IMPORTED_MODULE_1__.VStack)((0,_tuval_forms__WEBPACK_IMPORTED_MODULE_1__.HStack)((0,_tuval_forms__WEBPACK_IMPORTED_MODULE_1__.Spacer)(), (0,_tuval_forms__WEBPACK_IMPORTED_MODULE_1__.MenuButton)()
            .icon(_tuval_forms__WEBPACK_IMPORTED_MODULE_1__.Icons.Share)
            .model([
            {
                title: 'Linkedin',
                onClick: function () {
                    windowOpen("https://www.linkedin.com/sharing/share-offsite/?url=".concat(window.location.href), '_blank', getPopupPositionProperties({ width: 600, height: 600 }));
                }
            }
        ]), (0,_tuval_forms__WEBPACK_IMPORTED_MODULE_1__.ReactView)(react__WEBPACK_IMPORTED_MODULE_2___default().createElement("a", { href: url, target: "_blank" }, (0,_tuval_forms__WEBPACK_IMPORTED_MODULE_1__.HStack)((0,_tuval_forms__WEBPACK_IMPORTED_MODULE_1__.Icon)(_tuval_forms__WEBPACK_IMPORTED_MODULE_1__.Icons.ExternalPage))
            .cursor('pointer')
            .background({ default: '', hover: '#CCE5FF' })
            .allWidth(32).allHeight(32).cornerRadius(4)
            .render())), (0,_tuval_forms__WEBPACK_IMPORTED_MODULE_1__.HStack)((0,_tuval_forms__WEBPACK_IMPORTED_MODULE_1__.Icon)(_tuval_forms__WEBPACK_IMPORTED_MODULE_1__.Icons.Settings))
            .cursor('pointer')
            .background({ default: '', hover: '#CCE5FF' })
            .allWidth(32).allHeight(32).cornerRadius(4)
            ...
            .width(null)
            .overflow('hidden')
            .initial({ width: '0px' }).animate({ width: (showSettings || (_tuval_core__WEBPACK_IMPORTED_MODULE_0__.is.nullOrUndefined(url) && _tuval_core__WEBPACK_IMPORTED_MODULE_0__.is.nullOrEmpty(url))) ? '300px' : '0px' })
...
var EmptyView = function () { return (0,_tuval_forms__WEBPACK_IMPORTED_MODULE_0__.UIViewBuilder)(function () {
    return ((0,_tuval_forms__WEBPACK_IMPORTED_MODULE_0__.VStack)({ alignment: _tuval_forms__WEBPACK_IMPORTED_MODULE_0__.cTopLeading })((0,_tuval_forms__WEBPACK_IMPORTED_MODULE_0__.UIImage)('/images/com.document.view.trello/empty_image.svg')
...
module.exports = {
    application: {
        name: 'com.tuvalsoft.widget.office365-embedded',
...
//# sourceMappingURL=index.js.map
                    tuval$core.ModuleLoader.FireModuleLoadedEvent('com.tuvalsoft.widget.office365-embedded', tuval$core['__APPS__']['com.tuvalsoft.widget.office365-embedded']);
